...
public class RoomsController {
  ...
  public RoomsController(AppUserService appUserService, CleanedRoomsService cleanedRoomsService,
      DirtyRoomsService dirtyRoomsService, HistoryService historyService) {
