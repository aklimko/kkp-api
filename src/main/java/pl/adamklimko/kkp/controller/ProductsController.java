...
public class ProductsController {
  ...
  public ProductsController(AppUserService appUserService,
      BoughtProductsService boughtProductsService, MissingProductsService missingProductsService,
  ...
  public MissingProducts patchMissingProducts(@RequestBody MissingProducts missingProducts) {
    ...
    historyService
        .save(HistoryUtil.getHistoryEntry(user, productsEntry, null, ActionType.TO_BE_DONE));
