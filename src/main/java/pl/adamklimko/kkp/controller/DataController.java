...
public class DataController {
    ...
    public DataController(AppUserService appUserService, HistoryService historyService, MissingProductsService missingProductsService, DirtyRoomsService dirtyRoomsService) {
